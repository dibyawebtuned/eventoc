    ...
    <section id="services" className="py-20 bg-gradient-to-b from-[#0A0A0A] to-[#685736]">
      <div className="max-w-7xl mx-auto px-4 text-center flex flex-col gap-[25px] sm:gap-[50px]">
        ...
        <div className="flex flex-row items-center gap-[20px] justify-center">
          {/* Left_heading_line */}
          <div>
            <Image src={Left_heading_line} alt="Services" className="" />
          </div>
          {/* Title */}
          ...
          {/* Right_heading_line */}
          <div>
            <Image src={Right_heading_line} alt="Services" className="" />
          </div>
        </div>
        ...
        cursor-pointer 
        ${activeTab === tab.name ? "text-[#D7B26A]" : "text-white hover:text-[#D7B26A]"}
      `}
                style={{
