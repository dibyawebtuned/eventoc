...
export default function AddonsSection({
  title = "Add Ons",
  subtitle = "Our signature add-ons go beyond logistics — they elevate experiences into effortless luxury.",
  addons = [],
}) {
  return (
          ...
          {addons.map((addon, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Label */}
                <h3 className="text-white text-lg font-semibold mb-2">{addon.label}</h3>
